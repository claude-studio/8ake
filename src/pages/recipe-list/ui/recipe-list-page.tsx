...
export function RecipeListPage() {
  ...
  return (
    <>
      <header
        className="sticky top-0 z-40 bg-background backdrop-blur-sm"
        style={{ boxShadow: '0 1px 0 var(--border), 0 2px 0 var(--rule)' }}
      >
        <div className="mx-auto flex h-14 max-w-[1024px] items-center justify-between px-5">
          <div className="flex items-baseline gap-1.5">
            <span className="text-[22px] font-extrabold tracking-[-0.06em] text-primary">8ake</span>
